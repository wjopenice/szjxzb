...
<div class="page">
    ...
    <div class="flexigrid">
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a href="?r=admin/advertisement/add">
                ...
                <table style="width: 100%;">
                    <?php foreach ($arrData as $list): ?>
                        <tr>
                            ...
                            <td align="center" valign="middle" style="width: 25%; height: 100px; line-height: 100px; background: url(<?=$list['url']?>); background-size: 100% 100%;"></td>
                            <td align="center" valign="middle" style="width: 25%; height: 100px; line-height: 100px;">
                                <?php if($session->get('username') != "test"):?>
                                    <a href="?r=admin/advertisement/edit&id=<?=$list['id']?>">修改</a> | <a href="javascript:alert('未开放此功能')">删除</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
