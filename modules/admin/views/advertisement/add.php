...
<body>
    <div class="page">
        ...
        <form action="?r=admin/advertisement/add" method="post" enctype="multipart/form-data" id="addEditGoodsForm">
            ...
            <div class="ncap-form-default tab_div_1">
                <dl class="row">
                    ...
                    <dd class="opt">
                        <input type="text" required value="" name="name" class="input-txt">
