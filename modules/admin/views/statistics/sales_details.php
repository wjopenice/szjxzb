...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            <div class="ftitle">
                <h3>明细列表</h3><h5>（共<span>0</span>条记录）</h5>
            </div>
                ...
                <table cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <th align="center" abbr="article_title" axis="col3" class="">
                            <div style="width: 50px;" class="ta_c">ID</div>
                        </th>
                        <th align="left" abbr="article_title" axis="col3" class="">
                            <div style="width: 500px;" class="ta_l">商品名称</div>
                        </th>
                        <th align="left" abbr="article_title" axis="col3" class="">
                            <div style="width: 300px;" class="ta_l">商品规格</div>
                        </th>
                        <th align="center" abbr="ac_id" axis="col4" class="">
                            <div style="width: 100px;" class="ta_c">商品货号</div>
                        </th>
                        <th align="center" abbr="article_show" axis="col5" class="">
                            <div style="width: 50px;" class="ta_c">数量</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="width: 100px;" class="ta_c">售价</div>
                        </th>
                        <th align="center" abbr="user_id" axis="col4" class="">
                            <div style="width: 100px;" class="ta_c">下单会员</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="width: 120px;" class="ta_c">出售日期</div>
                        </th>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="width: 500px;" class="ta_l"></div>
                            </td>
                            <td align="left" class="">
                                <div style="width: 300px;" class="ta_l"></div>
                            </td>
                            <td align="center" class="">
