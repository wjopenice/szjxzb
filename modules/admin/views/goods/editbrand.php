...
<div class="page">
    ...
    <form action="?r=admin/goods/editbrand&id=<?=$arrData['id']?>" method="post" enctype="multipart/form-data" id="addEditGoodsForm">
        <!--通用信息-->
        <div class="ncap-form-default tab_div_1">
            <dl class="row">
                <dt class="tit"><label>品牌名称</label></dt>
                <dd class="opt"><input type="text" required value="<?=$arrData['name']?>" name="name" class="input-txt">*</dd>
            </dl>
            <dl class="row">
                <dt class="tit" style="line-height: 53px;"><label>品牌logo</label></dt>
                <dd class="opt">
                    <input type="file" name="file" value="" class="file"  />*
                    <img src="<?=$arrData['logo']?>" />
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit"><label>品牌描述</label></dt>
                <dd class="opt"><input type="text"  value="<?=$arrData['desc']?>" name="desc" class="input-txt"></dd>
            </dl>
            <dl class="row">
                <dt class="tit"><label>品牌地址</label></dt>
                <dd class="opt"><input type="text"  value="<?=$arrData['url']?>" name="url" class="input-txt"></dd>
            </dl>
