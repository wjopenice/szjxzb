...
<head>
    ...
    <link rel="stylesheet" href="<?=$url?>/Css/commonProblem/detail.css">
</head>
<body class="mHome">
...
<div class="page-group">
    <div class="detailTitle">平台的物流方式和时间？</div>
    <ul class="commonProblemUl">
        <li class="commonProblem">平台的物流方式是顺风快递，时间早上10:30到晚上19:00。</li>
    </ul>
</div>
...
<script src="<?=$url?>/Js/commonProblem/detail.js"></script>
</body>
</html>