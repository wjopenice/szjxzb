...
class ScanpayController extends PayController {

    public function actionIndex() {
        
    	$data = $_REQUEST;
        /*$resqn = 'shop_'.date('Ymd').date ( 'His' );
        $data = [
           'account' => '64735951',
           'resqn' => $resqn,
           'pay_amount' => 0.02,
    ...
    public function ipsPay($data,$pay_data){
        ...
        if($arr['GateWayRsp']['head']['RspCode'] === '000000'){
            $json_data = array(
                ...
                'trxstatus' => $arr['GateWayRsp']['head']['RspCode'] == '000000' ? '0000' : '10001',
