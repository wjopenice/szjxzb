$(function(){
    ...
    $("body.header").prepend('<div class="header cf" id="header"></div>');
    $("body.personalHeader").prepend('<div class="header cf" id="personalHeader"></div>');
    $("body.footer").append('<div class="footer" id="footer"></div>');

    ajaxHtml('header','../../View/share/header.html');
    ajaxHtml('personalHeader','../../View/share/personalHeader.html');
