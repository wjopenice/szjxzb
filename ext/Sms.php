...
class Sms {
    ...
    public function __construct($cofig = array()) {
        $cofig = array (
            'accessKeyId' => 'LTAIr9DcjX79dsVb',
            'accessKeySecret' => 'SyxdQZG8AkRTrMAnwoxH4yX9UKHPKy',
            'signName' => '手上科技',
            'templateCode' => 'SMS_126875946'
        );
        // 配置参数
    ...
    public function send_verify($mobile, $verify_code) {
        ...
        return $result;
        //var_dump($result);die;
        //http://g.alicdn.com/alidayu/handbook/help/error-code.html
