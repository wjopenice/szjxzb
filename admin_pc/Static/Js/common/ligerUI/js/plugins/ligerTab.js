...
(function ($)
{
    ...
    $.ligerDefaults.Tab = {
        ...
        // function(id){    
        //    if ($('#'+id).find('input')||$('#'+oId).find('textarea')) {    
        //       bombBox.bombBoxQuestion(null,'您输入的信息尚未保存，确认退出？');
        //         $('.jq_pub_bBoxModal').on('click', '#cancel', function () {                                                                                  
        //                 $('.jq_pub_bBoxModal,.lv_zhao').hide();                                                               
        //     });  
        //    }
        //      $('.jq_pub_bBoxModal').on('click', '#confirm', function () {                    
        //     });  
        //   id.stopPropagation();
        // },
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _setShowSwitch: function (value)
        {
            ...
            if (value)
            {
                ...
                $(".l-tab-switch", g.tab).mouseover(function ()
                {
                    g.toggleSwitch(this);
                }); 
            }
        ...
        addTabItem: function (options)
        {
            ...
            {
                g.selectTabItem(tabid);
                g.setTabItemTitle(text);
                g.setTabItemSrc(tabid,url);
                return;
            }
